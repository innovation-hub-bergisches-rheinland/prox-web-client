...
export class TagControllerService {
  ...
  public popularTagsUsingGET(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' }
  ): Observable<HttpResponse<Array<TagCount>>>;
  public popularTagsUsingGET(
    limit?: number,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' }
  ): Observable<HttpEvent<Array<TagCount>>>;
  public popularTagsUsingGET(
    limit?: number,
    observe: any = 'body',
    ...
    return this.httpClient.get<Array<TagCount>>(`${this.configuration.basePath}/tags/search/popularTags`, {
