...
export class JobOfferEntryLevelControllerService {
   ...
   */
  public getAll2(observe?: 'body', reportProgress?: boolean, options?: { httpHeaderAccept?: '*/*' }): Observable<Array<JobOfferEntryLevel>>;
  public getAll2(
    observe?: 'response',
  ...
  public getAll2(observe: any = 'body', reportProgress = false, options?: { httpHeaderAccept?: '*/*' }): Observable<any> {
    ...
    return this.httpClient.get<Array<JobOfferEntryLevel>>(`${this.configuration.basePath}/jobOfferEntryLevels`, {
  ...
  public getById2(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' }
  ): Observable<HttpResponse<JobOfferEntryLevel>>;
  public getById2(
    id: string,
    observe?: 'events',
    reportProgress?: boolean,
  ...
  public getById2(id: string, observe: any = 'body', reportProgress = false, options?: { httpHeaderAccept?: '*/*' }): Observable<any> {
    ...
    return this.httpClient.get<JobOfferEntryLevel>(`${this.configuration.basePath}/jobOfferEntryLevels/${encodeURIComponent(String(id))}`, {
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: headers,
      observe: observe,
