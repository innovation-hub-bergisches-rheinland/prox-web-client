...
import { CollectionModelEntityModelFaculty } from '@data/schema/openapi/professor-profile-service/models';
...
export class FacultyAPIService {
  ...
  /**
   * Get all faculties
   * @param sort Comma-separated property names to sort by (e.g. &#x60;name,abbreviation&#x60;)
  ...
  public getAllFaculties(
    ...
    return this.httpClient.get<CollectionModelEntityModelFaculty>(`${this.configuration.basePath}/faculties`, {
  ...
  public getFaculty1(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling getFaculty1.');
    }
    ...
    return this.httpClient.get<EntityModelFaculty>(`${this.configuration.basePath}/faculties/${encodeURIComponent(String(id))}`, {
      responseType: <any>responseType,
      withCredentials: this.configuration.withCredentials,
      headers: headers,
      observe: observe,
