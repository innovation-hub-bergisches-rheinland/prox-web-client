...
export class ProfessorOverviewControllerService {
  ...
  public getProfessorOverview(
    ...
    return this.httpClient.get<CollectionModelEntityModelProfessorOverviewDto>(
      `${this.configuration.basePath}/professors/overview`,
      {
