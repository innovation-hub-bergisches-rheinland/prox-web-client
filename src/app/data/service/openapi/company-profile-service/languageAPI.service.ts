...
export class LanguageAPIService {
  ...
  public getAllLanguages(
    types?: Array<'ANCIENT' | 'LIVING' | 'CONSTRUCTED' | 'HISTORICAL' | 'EXTINCT' | 'NONE'>,
    observe?: 'body',
  ...
  public getAllLanguages(
    ...
    return this.httpClient.get<CollectionModelEntityModelLanguage>(`${this.configuration.basePath}/languages`, {
  ...
  public getLanguage(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling getLanguage.');
    }
    ...
    return this.httpClient.get<EntityModelLanguage>(`${this.configuration.basePath}/languages/${encodeURIComponent(String(id))}`, {
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: headers,
      observe: observe,
