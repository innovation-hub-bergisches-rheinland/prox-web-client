...
@Component({
  selector: 'app-lecturer-editor-page',
  templateUrl: './lecturer-editor-page.component.html',
  styleUrls: ['./lecturer-editor-page.component.scss']
})
export class LecturerEditorPageComponent implements OnInit {
