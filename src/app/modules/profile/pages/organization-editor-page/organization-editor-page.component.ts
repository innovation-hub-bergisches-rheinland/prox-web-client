...
@Component({
  ...
  templateUrl: './organization-editor-page.component.html',
  styleUrls: ['./organization-editor-page.component.scss']
})
export class OrganizationEditorPageComponent implements OnInit {
